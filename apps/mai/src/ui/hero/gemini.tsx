      ...
      <div className="absolute -top-40 flex h-[890px] w-full items-center justify-center md:-top-36 ">
        <Link
          ...
          className={cn(
            ...
            'z-30 mx-auto mt-12 min-h-12 min-w-36 rounded-full bg-foreground px-2 py-1 font-sans shadow-md hover:bg-foreground/80 dark:bg-white dark:text-zinc-950 dark:hover:bg-white/80 md:mt-24 md:px-4 md:py-2 md:text-base ',
          )}
        >
          <MaiLogoIcon className="mr-2 size-8" />
          Try for free
        </Link>
      </div>
      <svg
