...
export const freeResources: FreeResource[] = [
  {
    ...
    image: function BlogImage() {
      return (
        <div className="dark:via-primary/60/60 absolute inset-0 flex items-center justify-center bg-[conic-gradient(at_top_left,_var(--tw-gradient-stops))] from-background via-primary/80 to-card">
  ...
  },
  {
    ...
    image: function AiBlogImage() {
      return (
        <div className="absolute inset-0 flex items-center justify-center bg-[conic-gradient(at_top_left,_var(--tw-gradient-stops))] from-background via-primary/80 to-card dark:via-primary/60">
