...
const SUPPORT_EMAIL = env.NEXT_PUBLIC_SAMBI_SUPPORT_EMAIL;

const buyUsMailtoLink = `mailto:${SUPPORT_EMAIL}?subject=We%20want%20to%20buy%20your%20company%20for%20a%20lot%20of%20dough&body=Hey%20sambi.dev%2C%20we%20think%20you're%20awesome.%20We%20got%20%F0%9F%92%B0%2C%20let's%20talk!`;

const writeAboutUsMailtoLink = `mailto:${SUPPORT_EMAIL}?subject=We%20want%20to%20sing%20your%20praises&body=Hey%20sambi.dev%2C%20we'd%20%E2%9D%A4%EF%B8%8F%20to%20tell%20your%20story.`;
