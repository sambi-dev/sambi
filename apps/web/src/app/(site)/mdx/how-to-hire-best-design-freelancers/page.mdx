import imagePerplexity from '#/images/llms/perplexity.jpg';

export const aiPost = {
  date: '2024-02-08',
  category: 'flow',
  title: 'How to hire the best design freelancers for remote creative work',
  description:
    'Master remote hiring for creatives. Discover proven strategies to find and onboard top design freelancers regardless of distance.',
  llm: {
    company: 'Perplexity',
    model: 'Perplexity 3.0',
    image: { src: imagePerplexity },
  },
  readMoreButtonText: 'Find a designer',
};
