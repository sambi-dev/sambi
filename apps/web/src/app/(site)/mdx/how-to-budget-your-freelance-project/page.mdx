...
export const aiPost = {
  date: '2024-02-09',
  category: 'plan',
  title: 'How to set a budget for your next freelance project',
  description:
    'Navigate budget planning for your freelance project with ease—learn to set realistic financial goals that ensure quality without breaking the bank.',
  llm: {
    company: 'Meta',
    model: 'Llama2',
    image: { src: imageLlama },
  },
  readMoreButtonText: 'Budget your project',
};
