import imageGemini from '#/images/llms/gemini.jpg';

export const aiPost = {
  date: '2024-02-15',
  category: 'flow',
  title: '5 key hallmarks of successful freelancers that deliver',
  description:
    'Uncover the critical characteristics shared by high-achieving freelancers to elevate your freelance career beyond the ordinary.',
  llm: {
    company: 'Google Gemini',
    model: 'Gemini 1.5',
    image: { src: imageGemini },
  },
  readMoreButtonText: 'Explore hallmarks',
};
