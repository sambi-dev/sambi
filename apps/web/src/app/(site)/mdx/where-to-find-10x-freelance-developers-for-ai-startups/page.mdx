...
export const article = {
  date: '2024-02-06',
  category: 'plan',
  title: 'Where to find the best freelance developers for your AI startup',
  description:
    'Elevate your AI startup recruiting. Uncover the prime spots to scout elite freelance developers who can transform your innovative vision into reality, seamlessly.',
  llm: {
    company: 'Google Gemini',
    model: 'Gemini 1.5',
    image: { src: imageGemini },
  },
  readMoreButtonText: 'Hire AI Developer',
};
