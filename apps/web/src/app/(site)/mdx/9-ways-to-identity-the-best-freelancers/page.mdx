import imageLlama from '#/images/llms/llama.jpg';

export const aiPost = {
  date: '2024-02-18',
  category: 'flow',
  title: '9 ways to identify the best freelancers and where to find them',
  description:
    'Explore the traits that define elite freelancers and learn how to embody these qualities for unparalleled career growth and success.',
  llm: {
    company: 'Meta',
    model: 'Llama2',
    image: { src: imageLlama },
  },
  readMoreButtonText: 'Identify the best',
};
