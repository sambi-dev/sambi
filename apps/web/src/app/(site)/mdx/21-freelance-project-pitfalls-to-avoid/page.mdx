import imageMistral from '#/images/llms/mistral.jpg';

export const article = {
  date: '2024-02-10',
  category: 'flow',
  title: '21 freelance project pitfalls to avoid',
  description:
    'Sidestep common freelancing mistakes. Navigate your freelance journey with confidence by avoiding 21 critical project pitfalls for sustained success and growth.',
  llm: {
    company: 'Mistral',
    model: 'MIXTRAL 8X7B',
    image: { src: imageMistral },
  },
  readMoreButtonText: 'Avoid the pitfalls',
};
