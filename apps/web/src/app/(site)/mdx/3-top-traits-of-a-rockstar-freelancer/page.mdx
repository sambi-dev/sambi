import imageGpt from '#/images/llms/chatgpt.jpg';

export const aiPost = {
  date: '2024-02-16',
  category: 'flow',
  title: '3 key traits of a rockstar freelancer',
  description:
    'Unlock the secrets to freelancing success. Discover the top traits that set apart exceptional freelancers and propel your career to new heights.',
  llm: {
    company: 'OpenAI',
    model: 'GPT 4 Turbo',
    image: { src: imageGpt },
  },
  readMoreButtonText: 'Find a rockstar',
};
