...
export const post = {
  ...
  description:
    'Learn the art of overcoming the suck in marketing, embracing failure, and reigniting your drive. Transform fear into action and success.',
  author: {
    name: 'Rebekah Radice',
    role: 'Growth',
    image: { src: imageRebekah },
  },
  readMoreButtonText: 'Overcome demons',
};
