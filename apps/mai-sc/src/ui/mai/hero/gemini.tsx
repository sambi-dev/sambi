...
import {
  ...
  TextGenerateEffect,
} from '#/ui/mai/text-generate-effect';
    ...
    <div className={cn('sticky top-80', className)}>
      <div className="mt-24 px-6 sm:py-24 md:mt-0 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <TextGenerateEffect
            text={heroText}
            className="text-pretty lg:text-lg lg:font-medium"
          />
        </div>
      </div>
      <div className="absolute -top-40 flex h-[890px] w-full items-center justify-center md:-top-36 ">
        <Link
          ...
          className={cn(
            ...
            'z-50 mx-auto mt-12 min-h-12 min-w-36 rounded-full bg-foreground px-2 py-1 font-sans shadow-md hover:bg-foreground/80 dark:bg-white dark:text-zinc-950 dark:hover:bg-white/80 md:mt-24 md:px-4 md:py-2 md:text-base',
          )}
        >
          Start Research
          <ArrowRightIcon className="ml-2 text-primary" />
        </Link>
      </div>
      <svg
        width="1440"
